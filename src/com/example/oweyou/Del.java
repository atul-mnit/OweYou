...
public class Del extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		del.dropTables();
		del.close();
		startActivity(new Intent(Del.this, First.class));
	...
	public void onClick(View v) {
		...
		case R.id.bDel:
			...
			if(l1>cntr || l1<0){
				Toast.makeText(Del.this, "Invalid Serial Number", Toast.LENGTH_SHORT).show();
			}else{
			del.deleteEntry(l1);
			del.deleteTempEntry(l1);
			del.close();
			Toast.makeText(Del.this, "Partner Deleted", Toast.LENGTH_SHORT).show();
			startActivity(new Intent(Del.this, Final.class));
			}
			/*}catch (Exception e){
				worked = false;
